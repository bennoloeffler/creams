...
{:user {:env {:clojurenote-demo-key    "KEY"
              :clojurenote-demo-secret "SECRET"}}}


(defn config []
  {
   :key      "bennoloeffler-2708" ;(environ/env :clojurenote-demo-key)
   ; Or use :key "YOUR-KEY"
   :secret   "7dfe6594731f5751" ;(environ/env :clojurenote-demo-secret)
